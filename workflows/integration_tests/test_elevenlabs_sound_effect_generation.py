...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_elevenlabs_sound_effect_generation"
...
with GriptapeNodes.ContextManager().flow(flow_name):
    gen_node = GriptapeNodes.handle_request(CreateNodeRequest(
        ...
        node_name="ElevenLabsSoundEffectGeneration", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
    ...
    with GriptapeNodes.ContextManager().node(start_node):
        GriptapeNodes.handle_request(SetParameterValueRequest(
            ...
            value="Thunder clap", initial_setup=True, is_output=False))
