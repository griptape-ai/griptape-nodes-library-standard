...
with GriptapeNodes.ContextManager().flow(flow_name):
    ltx_node = GriptapeNodes.handle_request(CreateNodeRequest(
        ...
        node_name="LTX Text To Video Generation", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
    gen_node = GriptapeNodes.handle_request(CreateNodeRequest(
        node_type="SeedVRVideoUpscale", specific_library_name="Griptape Nodes Library",
        node_name="SeedVRVideoUpscale", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
    ...
    GriptapeNodes.handle_request(CreateConnectionRequest(
        ...
        target_node_name=gen_node, target_parameter_name="video_url", initial_setup=True))
    GriptapeNodes.handle_request(CreateConnectionRequest(
