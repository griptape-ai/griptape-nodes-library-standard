...
with GriptapeNodes.ContextManager().flow(flow_name):
    ...
    gen_node = GriptapeNodes.handle_request(CreateNodeRequest(
        node_type="SeedVRImageUpscale", specific_library_name="Griptape Nodes Library",
        node_name="SeedVRImageUpscale", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
    ...
    GriptapeNodes.handle_request(CreateConnectionRequest(
        ...
        target_node_name=gen_node, target_parameter_name="image_url", initial_setup=True))
    GriptapeNodes.handle_request(CreateConnectionRequest(
