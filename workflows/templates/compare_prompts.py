...
# image = "https://raw.githubusercontent.com/griptape-ai/griptape-nodes-library-standard/main/workflows/templates/thumbnail_compare_prompts.webp"
...
top_level_unique_values_dict = {
    "1f7302b7-3a31-4ecc-a978-75be0b5e2e43": pickle.loads(
    ...
    "e410ef61-23df-4e91-915e-636a1af08d16": pickle.loads(
    ...
    "40a83875-91e7-43fb-a95b-f303b443bb7f": pickle.loads(
    ...
    "867704c6-f1c4-4a3c-91ad-51b8ff629867": pickle.loads(
        b"\x80\x04\x95\x15\x00\x00\x00\x00\x00\x00\x00\x8c\x11A happy capybara.\x94."
    ),
    "e6644431-d5e6-4bfd-9236-78e4fb99d2fc": pickle.loads(
    ...
    "e66f3f8c-7a91-4331-b4f2-a2240c4cd546": pickle.loads(
    ...
    "d2ae181f-0ace-4622-babc-408a1c15c8cc": pickle.loads(b"\x80\x04]\x94."),
}
...
with GriptapeNodes.ContextManager().flow(flow0_name):
    ...
    node1_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="NextStep",
            metadata={
                "position": {"x": 2909.3971815523346, "y": 345.2384738357889},
    ...
    node2_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 80.06000370958543, "y": 705.2384738357889},
                "size": {"width": 600, "height": 431},
    ...
    node3_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -650, "y": -198.91857581254848},
                "library_node_metadata": {"category": "text", "description": "TextInput node"},
                "library": "Griptape Nodes Library",
                "node_type": "TextInput",
                "showaddparameter": False,
    ...
    node4_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 797.4744747341949, "y": 705.2384738357889},
                "library_node_metadata": {"category": "text", "description": "MergeTexts node"},
                "library": "Griptape Nodes Library",
                "node_type": "MergeTexts",
                "showaddparameter": False,
                "size": {"width": 621, "height": 440},
                "category": "text",
            },
            initial_setup=True,
        )
    ...
    node5_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 80.06000370958543, "y": -198.91857581254848},
                "library_node_metadata": {
                    "category": "image",
    ...
    node6_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 797.4744747341949, "y": -198.91857581254848},
                "library_node_metadata": {
                    "category": "image",
                    "description": "Generates an image using Griptape Cloud, or other provided image generation models",
                },
    ...
    node7_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 1524.623921769481, "y": 525.2384738357889},
                "library_node_metadata": {
                    "category": "agents",
    ...
    node8_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 2235.872218160345, "y": 345.2384738357889},
                "library_node_metadata": {
                    "category": "image",
                    "description": "Generates an image using Griptape Cloud, or other provided image generation models",
                },
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["1f7302b7-3a31-4ecc-a978-75be0b5e2e43"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["e410ef61-23df-4e91-915e-636a1af08d16"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["40a83875-91e7-43fb-a95b-f303b443bb7f"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["867704c6-f1c4-4a3c-91ad-51b8ff629867"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node4_name):
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node4_name,
                value=top_level_unique_values_dict["e6644431-d5e6-4bfd-9236-78e4fb99d2fc"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node4_name,
                value=top_level_unique_values_dict["a9e76088-3628-49dd-a8f3-90770d373ac5"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node5_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["5aeee4a2-df96-4242-a89b-212197c089df"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="image_size",
                node_name=node5_name,
                value=top_level_unique_values_dict["6917b7b2-3920-459c-8fea-abc6f0606377"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node5_name,
                value=top_level_unique_values_dict["e66f3f8c-7a91-4331-b4f2-a2240c4cd546"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node6_name):
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="enhance_prompt",
                node_name=node6_name,
                value=top_level_unique_values_dict["db0986d8-c34b-49ab-b5c1-c580c3e72e88"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node7_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["3edb549c-973b-4d00-adc6-6f9d8ffe7482"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="prompt",
                node_name=node7_name,
                value=top_level_unique_values_dict["be36c573-4ae9-482c-86a2-d17a0b555d05"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node7_name,
                value=top_level_unique_values_dict["d557d7ff-9186-4bc4-95a3-03d11d88901d"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node7_name,
                value=top_level_unique_values_dict["d2ae181f-0ace-4622-babc-408a1c15c8cc"],
                initial_setup=True,
                is_output=False,
            )
        )
