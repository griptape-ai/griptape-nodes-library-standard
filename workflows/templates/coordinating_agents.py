...
top_level_unique_values_dict = {
    "1bc33326-c661-4791-bd5d-6eeae82844f0": pickle.loads(
    ...
    "725e7e30-c81b-4e38-af0a-c8c688b60c29": pickle.loads(
    ...
    "a4a99439-0fc6-4294-8488-c9a804181a5b": pickle.loads(
    ...
    "3498097d-d83a-4592-a8b9-a59616a99e35": pickle.loads(
        b"\x80\x04\x95\n\x00\x00\x00\x00\x00\x00\x00\x8c\x06gpt-4o\x94."
    ),
    "59625301-80dc-4034-92a5-1f9bd9cd42be": pickle.loads(
        b'\x80\x04\x95&\x00\x00\x00\x00\x00\x00\x00\x8c"Write me a 4-line story in Spanish\x94.'
    ),
    "41fc8582-df50-459e-891e-d59cf0623581": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00\x8c\x00\x94."),
    "08345808-9c91-47c8-8701-4f9535fb6a41": pickle.loads(b"\x80\x04]\x94."),
    "54cdcb6c-5b3c-40aa-8278-69d29c8a1dc5": pickle.loads(b"\x80\x04]\x94."),
    "a87ea8f7-dd52-4663-b032-d35988c22d21": pickle.loads(
    ...
    "c00b6ce6-91a6-47b2-a8ba-c068af4ac9a1": pickle.loads(b"\x80\x04\x89."),
    "b84f5af0-dee2-4f57-9767-faea9a332cb8": pickle.loads(
    ...
    "6b454928-f875-4213-ac74-79ddee5bddab": pickle.loads(
    ...
    "d95160b5-47e9-4e58-9010-2ebc354e285a": pickle.loads(b"\x80\x04]\x94."),
    "84fa4d64-89ab-4382-8ba5-9a8943f489ab": pickle.loads(b"\x80\x04]\x94."),
    "2f968b49-e8e7-465a-b395-85320f19ed20": pickle.loads(
    ...
    "0c5b96ac-eee4-441d-9ef0-79c22d66434e": pickle.loads(
        b"\x80\x04\x95\x1b\x00\x00\x00\x00\x00\x00\x00\x8c\x17rewrite this in english\x94."
    ),
    "dd2ea0fb-b3f5-4a95-a2d2-c7b48d6d265f": pickle.loads(
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["1bc33326-c661-4791-bd5d-6eeae82844f0"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["725e7e30-c81b-4e38-af0a-c8c688b60c29"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["a4a99439-0fc6-4294-8488-c9a804181a5b"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["3498097d-d83a-4592-a8b9-a59616a99e35"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["59625301-80dc-4034-92a5-1f9bd9cd42be"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["41fc8582-df50-459e-891e-d59cf0623581"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["08345808-9c91-47c8-8701-4f9535fb6a41"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["54cdcb6c-5b3c-40aa-8278-69d29c8a1dc5"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["a87ea8f7-dd52-4663-b032-d35988c22d21"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["c00b6ce6-91a6-47b2-a8ba-c068af4ac9a1"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["b84f5af0-dee2-4f57-9767-faea9a332cb8"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="prompt",
                node_name=node3_name,
                value=top_level_unique_values_dict["6b454928-f875-4213-ac74-79ddee5bddab"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="tools",
                node_name=node3_name,
                value=top_level_unique_values_dict["d95160b5-47e9-4e58-9010-2ebc354e285a"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="rulesets",
                node_name=node3_name,
                value=top_level_unique_values_dict["84fa4d64-89ab-4382-8ba5-9a8943f489ab"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="output",
                node_name=node3_name,
                value=top_level_unique_values_dict["2f968b49-e8e7-465a-b395-85320f19ed20"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node4_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["0c5b96ac-eee4-441d-9ef0-79c22d66434e"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node4_name,
                value=top_level_unique_values_dict["dd2ea0fb-b3f5-4a95-a2d2-c7b48d6d265f"],
                initial_setup=True,
                is_output=False,
            )
        )
