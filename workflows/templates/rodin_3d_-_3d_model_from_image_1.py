...
#
# [tool.griptape-nodes]
# name = "/Users/collindutter/Projects/griptape/griptape-nodes-libraries/griptape-nodes-library-standard/workflows/templates/rodin_3d_-_3d_model_from_image_1"
...
# is_template = false
# creation_date = 2026-03-12T23:11:11.329991Z
...
top_level_unique_values_dict = {
    "c85fc84f-ed9c-46de-aee3-ad9ce8cfd266": pickle.loads(
    ...
    "9813daa2-3c1a-4cf1-9384-ebeae6a4157a": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00\x8c\x00\x94."),
    "6b9fb11b-f54b-4ff1-8fc1-b6931ca608c5": pickle.loads(
    ...
    "628a8135-6dc2-4ca8-b2de-e663822288f6": pickle.loads(
    ...
    "26cef384-4f3f-424b-a112-e8469944fc71": pickle.loads(
        b"\x80\x04\x95\x08\x00\x00\x00\x00\x00\x00\x00\x8c\x04none\x94."
    ),
    "3e7098a1-57ff-4a69-85a0-fb6aad57b4f8": pickle.loads(b"\x80\x04\x89."),
    "c4dccf11-d1b7-431a-9dc3-574acd4b00de": pickle.loads(
        b"\x80\x04\x950\x00\x00\x00\x00\x00\x00\x00\x8c,<Results will appear when the node executes>\x94."
    ),
    "2ecec6ad-9a9c-4d4d-8a7b-50d52d4119ea": pickle.loads(
    ...
    "ccf33a1b-687e-405b-b0c8-a7aec0db9f39": pickle.loads(
    ...
    "ea9e5fb5-6ab7-4228-9ca3-9907e525c314": pickle.loads(
    ...
    "8303b552-f54a-4351-875c-ae0a4f686452": pickle.loads(
        b"\x80\x04\x95'\x00\x00\x00\x00\x00\x00\x00\x8c#Merge the text to generate a prompt\x94."
    ),
    "ee41f1d5-3fbc-4611-a45c-b719e2df3126": pickle.loads(
    ...
    "aa86833d-1c95-4409-81b6-1eebac09e909": pickle.loads(
    ...
    "70d8f80b-ed65-4c24-9d44-1b24e71f06e0": pickle.loads(
        b"\x80\x04\x95#\x00\x00\x00\x00\x00\x00\x00\x8c\x1flight background, soft shadows.\x94."
    ),
    "fe913f49-a36c-4152-b362-655a8a019463": pickle.loads(
        b"\x80\x04\x95\x08\x00\x00\x00\x00\x00\x00\x00\x8c\x04\\n\\n\x94."
    ),
    "94964b6b-ee3a-4bcc-a2ec-f58c7e880e71": pickle.loads(
    ...
    "e7e42d08-3b07-43e3-8072-1b8150c2ec90": pickle.loads(
    ...
    "4caa3062-88bf-45d0-8dd1-41463b664587": pickle.loads(
    ...
    "a6201b88-8520-4ddb-aa80-e786b81ec574": pickle.loads(
    ...
    "05e3dfe3-9c8c-4dcc-9647-b701b247c723": pickle.loads(
    ...
    "b81cda28-8099-423f-90a1-b248d6e92526": pickle.loads(
        b"\x80\x04\x95\x10\x00\x00\x00\x00\x00\x00\x00\x8c\x0cgpt-4.1-mini\x94."
    ),
    "77c88056-37fd-40ac-8843-6cb0d57e3d51": pickle.loads(
    ...
    "01f6cd7d-7f54-4273-94b3-5d20e87d8396": pickle.loads(b"\x80\x04\x88."),
    "1459a502-2dbe-46f5-8bad-b7c48fad5bc1": pickle.loads(
        b"\x80\x04\x95\x15\x00\x00\x00\x00\x00\x00\x00\x8c\x11Flux.2 [klein] 9B\x94."
    ),
    "cc37c760-1c1d-4841-9e9e-6f97f1d257db": pickle.loads(
    ...
    "d6f310fc-8261-475f-ac29-bfde4c9ba200": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00M`\x05."),
    "1c138072-785d-4780-8ddd-98f3ab0cc277": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00M\x00\x03."),
    "97898d41-359e-43f3-aed1-1a01edfe482d": pickle.loads(b"\x80\x04K*."),
    "cfce9245-7360-4174-bee1-251fb139e5a0": pickle.loads(
        b"\x80\x04\x95\x08\x00\x00\x00\x00\x00\x00\x00\x8c\x04jpeg\x94."
    ),
    "2ae9e1cf-e5ac-459a-b9f6-0671840e25c4": pickle.loads(
        b"\x80\x04\x95\x15\x00\x00\x00\x00\x00\x00\x00\x8c\x11least restrictive\x94."
    ),
    "4b744809-30a5-496c-80b3-e949b317b5ff": pickle.loads(b"\x80\x04K2."),
    "2b924d43-7598-4976-927c-57ea8b42fc5c": pickle.loads(
        b"\x80\x04\x95\n\x00\x00\x00\x00\x00\x00\x00G@\x12\x00\x00\x00\x00\x00\x00."
    ),
    "3c0f0f72-ddec-430b-9128-b0107cadfe1a": pickle.loads(
    ...
    "f1213d6a-c22f-4b4c-82b3-9f97ed390024": pickle.loads(b"\x80\x04]\x94."),
    "57ec81e3-f3a5-4c7b-86d3-6820b41a5d87": pickle.loads(
        b"\x80\x04\x95\x07\x00\x00\x00\x00\x00\x00\x00\x8c\x03hat\x94."
    ),
    "34754d75-bc9b-4a3e-98b1-fd8277b62409": pickle.loads(b"\x80\x04]\x94."),
    "b42ed2f9-b3b3-4ed5-b4e0-033799777ce0": pickle.loads(
        b"\x80\x04\x95\n\x00\x00\x00\x00\x00\x00\x00\x8c\x06concat\x94."
    ),
    "0593a8be-a9fc-40a1-81be-31e42ec2c416": pickle.loads(
        b"\x80\x04\x95\x07\x00\x00\x00\x00\x00\x00\x00\x8c\x03glb\x94."
    ),
    "8c0e8806-0846-4339-b440-cb38b0a93fbf": pickle.loads(
        b"\x80\x04\x95\x07\x00\x00\x00\x00\x00\x00\x00\x8c\x03PBR\x94."
    ),
    "6d5fd8e5-8a80-4ad4-a792-cc7b80464618": pickle.loads(
        b"\x80\x04\x95\n\x00\x00\x00\x00\x00\x00\x00\x8c\x06medium\x94."
    ),
    "cffff38d-20c2-43f2-8a56-8ed132196490": pickle.loads(
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["c85fc84f-ed9c-46de-aee3-ad9ce8cfd266"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="image",
                node_name=node0_name,
                value=top_level_unique_values_dict["9813daa2-3c1a-4cf1-9384-ebeae6a4157a"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["6b9fb11b-f54b-4ff1-8fc1-b6931ca608c5"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="path",
                node_name=node1_name,
                value=top_level_unique_values_dict["628a8135-6dc2-4ca8-b2de-e663822288f6"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["26cef384-4f3f-424b-a112-e8469944fc71"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["3e7098a1-57ff-4a69-85a0-fb6aad57b4f8"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["c4dccf11-d1b7-431a-9dc3-574acd4b00de"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["2ecec6ad-9a9c-4d4d-8a7b-50d52d4119ea"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["ccf33a1b-687e-405b-b0c8-a7aec0db9f39"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node4_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["ea9e5fb5-6ab7-4228-9ca3-9907e525c314"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node5_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["8303b552-f54a-4351-875c-ae0a4f686452"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node6_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["ee41f1d5-3fbc-4611-a45c-b719e2df3126"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node6_name,
                value=top_level_unique_values_dict["aa86833d-1c95-4409-81b6-1eebac09e909"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node6_name,
                value=top_level_unique_values_dict["70d8f80b-ed65-4c24-9d44-1b24e71f06e0"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node6_name,
                value=top_level_unique_values_dict["fe913f49-a36c-4152-b362-655a8a019463"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node6_name,
                value=top_level_unique_values_dict["94964b6b-ee3a-4bcc-a2ec-f58c7e880e71"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node8_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["e7e42d08-3b07-43e3-8072-1b8150c2ec90"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node9_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["4caa3062-88bf-45d0-8dd1-41463b664587"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node10_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["a6201b88-8520-4ddb-aa80-e786b81ec574"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node11_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["05e3dfe3-9c8c-4dcc-9647-b701b247c723"],
                initial_setup=True,
                is_output=True,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node11_name,
                value=top_level_unique_values_dict["b81cda28-8099-423f-90a1-b248d6e92526"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node11_name,
                value=top_level_unique_values_dict["77c88056-37fd-40ac-8843-6cb0d57e3d51"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node11_name,
                value=top_level_unique_values_dict["01f6cd7d-7f54-4273-94b3-5d20e87d8396"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node12_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["1459a502-2dbe-46f5-8bad-b7c48fad5bc1"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["cc37c760-1c1d-4841-9e9e-6f97f1d257db"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["d6f310fc-8261-475f-ac29-bfde4c9ba200"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["1c138072-785d-4780-8ddd-98f3ab0cc277"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="seed",
                node_name=node12_name,
                value=top_level_unique_values_dict["97898d41-359e-43f3-aed1-1a01edfe482d"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["cfce9245-7360-4174-bee1-251fb139e5a0"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["2ae9e1cf-e5ac-459a-b9f6-0671840e25c4"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["4b744809-30a5-496c-80b3-e949b317b5ff"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["2b924d43-7598-4976-927c-57ea8b42fc5c"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node13_name):
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="prompt",
                node_name=node13_name,
                value=top_level_unique_values_dict["3c0f0f72-ddec-430b-9128-b0107cadfe1a"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="input_images",
                node_name=node13_name,
                value=top_level_unique_values_dict["f1213d6a-c22f-4b4c-82b3-9f97ed390024"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node14_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["57ec81e3-f3a5-4c7b-86d3-6820b41a5d87"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="input_images",
                node_name=node14_name,
                value=top_level_unique_values_dict["34754d75-bc9b-4a3e-98b1-fd8277b62409"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node14_name,
                value=top_level_unique_values_dict["b42ed2f9-b3b3-4ed5-b4e0-033799777ce0"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node14_name,
                value=top_level_unique_values_dict["0593a8be-a9fc-40a1-81be-31e42ec2c416"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node14_name,
                value=top_level_unique_values_dict["8c0e8806-0846-4339-b440-cb38b0a93fbf"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node14_name,
                value=top_level_unique_values_dict["6d5fd8e5-8a80-4ad4-a792-cc7b80464618"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node14_name,
                value=top_level_unique_values_dict["cffff38d-20c2-43f2-8a56-8ed132196490"],
                initial_setup=True,
                is_output=False,
            )
        )
