...
# is_template = true
# image = "https://raw.githubusercontent.com/griptape-ai/griptape-nodes-library-standard/main/workflows/templates/thumbnail_nano_banana_pro_-_image_collage.webp"
#
# ///
...
top_level_unique_values_dict = {
    "bb4188c3-cb4d-48a9-a331-24e614685a7f": pickle.loads(
        b"\x80\x04\x95\x96\x00\x00\x00\x00\x00\x00\x00\x8c\x92https://images.pdimagearchive.org/collections/posed-portraits-of-19th-century-baseball-stars/4051199982_718521f59f_z.jpg?zz=1?width=438&height=800\x94."
    ),
    "86d5309a-43ab-417d-800c-9e9a9e000a2c": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00\x8c\x00\x94."),
    "79b56dd7-7f97-42fe-acd3-b0e0a1b3369a": pickle.loads(b"\x80\x04\x88."),
    "16ad9d25-a6e2-4d58-b732-1aafa81f108a": pickle.loads(
    ...
    "a305ee94-1ccf-45c4-8418-1dfaddd2eb9d": pickle.loads(
        b"\x80\x04\x95F\x00\x00\x00\x00\x00\x00\x00\x8cBCreate a T-pose for this character to provide a base to work from.\x94."
    ),
    "ba092116-9834-43e6-822a-c656f194e9c9": pickle.loads(
        b"\x80\x04\x95`\x00\x00\x00\x00\x00\x00\x00\x8c\\Use Nano Banana Pro to generate 4 unique images of this character in various urban settings.\x94."
    ),
    "a4911989-e9a2-4faf-9164-08b0fb05f937": pickle.loads(
    ...
    "7e75b32d-e8ef-4187-a032-28a2b20a0691": pickle.loads(
        b"\x80\x04\x95u\x01\x00\x00\x00\x00\x00\x00]\x94\x8c%griptape.artifacts.image_url_artifact\x94\x8c\x10ImageUrlArtifact\x94\x93\x94)\x81\x94}\x94(\x8c\x04type\x94\x8c\x10ImageUrlArtifact\x94\x8c\x0bmodule_name\x94\x8c%griptape.artifacts.image_url_artifact\x94\x8c\x02id\x94\x8c a4469f447b384d728344c1863ee19a58\x94\x8c\treference\x94N\x8c\x04meta\x94}\x94\x8c\x04name\x94h\x0b\x8c\x16encoding_error_handler\x94\x8c\x06strict\x94\x8c\x08encoding\x94\x8c\x05utf-8\x94\x8c\x05value\x94\x8cUhttp://localhost:8124/workspace/static_files/4051199982_718521f59f_z.jpg?t=1766028965\x94uba."
    ),
    "30bc8bde-6bb6-4981-b3f5-df5ec4ebd446": pickle.loads(b"\x80\x04]\x94."),
    "7dc27ed6-9a50-46be-9dda-d3e7b040258a": pickle.loads(b"\x80\x04]\x94."),
    "cb239851-7953-446c-9c52-2c60ea224bc9": pickle.loads(
        b"\x80\x04\x95\x08\x00\x00\x00\x00\x00\x00\x00\x8c\x0416:9\x94."
    ),
    "45e7ba27-4f5f-4e29-afc0-562a6c335cc1": pickle.loads(
        b"\x80\x04\x95\x06\x00\x00\x00\x00\x00\x00\x00\x8c\x021K\x94."
    ),
    "4e5fa702-10bf-4d2b-9527-22ff71d2ff07": pickle.loads(
        b"\x80\x04\x95\n\x00\x00\x00\x00\x00\x00\x00G?\xf0\x00\x00\x00\x00\x00\x00."
    ),
    "5a7bc4ae-03b0-4154-a0c9-74a54ff37ad5": pickle.loads(
        b"\x80\x04\x954\x02\x00\x00\x00\x00\x00\x00X-\x02\x00\x00A collage of 4 hyper-realistic photos of this vintage character as a tourist in various modern urban settings. Each image highlights a different unique confusing situation for them. \n\nMaintain vintage color grade and texture ONLY for the reference character. All other characters and the environment are modern, unique, and hip with realistic contrast and color tones. Background elements are softly out of focus with subtle noise similar to a real camera sensor.\n\nReduce contrast and saturation on the vintage reference character only.\n\nCanon EOS Rebel T7.\x94."
    ),
    "9d670339-5762-4adf-a45a-1f9359d6e781": pickle.loads(b"\x80\x04]\x94."),
    "7b7257ba-95b8-48f0-bf5c-c80f95b6315e": pickle.loads(b"\x80\x04]\x94."),
    "581c5698-ebbd-4f10-9ddb-ca58741768a8": pickle.loads(
...
with GriptapeNodes.ContextManager().flow(flow0_name):
    ...
    node1_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "node_type": "EndFlow",
                "showaddparameter": True,
                "position": {"x": 2005.0163782533587, "y": 135.93260401626833},
    ...
    node3_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -1079.3184088273833, "y": -522.7913959331105},
    ...
    node5_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 2",
            metadata={
                "position": {"x": 505.64340168996534, "y": -96.10564382947182},
    ...
    node6_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 3",
            metadata={
                "position": {"x": 1247.684529701857, "y": -96.10564382947182},
    ...
    node7_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 4",
            metadata={
                "position": {"x": 2005.0163782533587, "y": -96.10564382947182},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": NodeMetadata(
                    category="misc",
                    description="Create a note node to provide helpful context in your workflow",
    ...
    node8_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "library": "Griptape Nodes Library",
                "node_type": "GoogleImageGeneration",
                "position": {"x": 505.64340168996534, "y": 135.93260401626833},
                "size": {"width": 600, "height": 1056},
            },
            initial_setup=True,
        )
    ).node_name
    with GriptapeNodes.ContextManager().node(node8_name):
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                parameter_name="input_images_ParameterListUniqueParamID_c79eb23ab1b84ae9ae6bdc5d609030e7",
                default_value=[],
    ...
    node9_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            node_type="GoogleImageGeneration",
            specific_library_name="Griptape Nodes Library",
            node_name="Google Nano Banana Image Generation_1",
            metadata={
                "library_node_metadata": NodeMetadata(
                    category="image",
                    description="Generate images using Google models via Griptape model proxy",
                ...
                "library": "Griptape Nodes Library",
                "node_type": "GoogleImageGeneration",
                "position": {"x": 1247.684529701857, "y": 135.93260401626833},
                "size": {"width": 616, "height": 1311},
            },
            initial_setup=True,
        )
    ).node_name
    with GriptapeNodes.ContextManager().node(node9_name):
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                parameter_name="input_images_ParameterListUniqueParamID_201d9a1a35cb45798efe578b6e60d2da",
                default_value=[],
                tooltip="Optional reference images for the generation",
                type="ImageUrlArtifact",
                input_types=["ImageUrlArtifact", "ImageArtifact"],
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            target_parameter_name="input_images_ParameterListUniqueParamID_c79eb23ab1b84ae9ae6bdc5d609030e7",
            initial_setup=True,
        )
    )
    GriptapeNodes.handle_request(
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            target_parameter_name="input_images_ParameterListUniqueParamID_201d9a1a35cb45798efe578b6e60d2da",
            initial_setup=True,
        )
    )
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["bb4188c3-cb4d-48a9-a331-24e614685a7f"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="image",
                node_name=node0_name,
                value=top_level_unique_values_dict["86d5309a-43ab-417d-800c-9e9a9e000a2c"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["79b56dd7-7f97-42fe-acd3-b0e0a1b3369a"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["16ad9d25-a6e2-4d58-b732-1aafa81f108a"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="image",
                node_name=node1_name,
                value=top_level_unique_values_dict["1e77dee1-fde9-4443-9f6f-1ff94109f299"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["0b1901f0-7c93-4eeb-b08e-44d8af0e4a55"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="path",
                node_name=node2_name,
                value=top_level_unique_values_dict["c6548deb-55f1-4112-a87b-cfea9d0b9c18"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["654dc593-b4f8-4eb7-9684-7f664011f095"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="was_successful",
                node_name=node2_name,
                value=top_level_unique_values_dict["f8ce8227-a722-48a5-8bf5-7ff4dd8b2f2e"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="result_details",
                node_name=node2_name,
                value=top_level_unique_values_dict["6375dfc7-9551-4f69-a7f0-2367ccd8227e"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["13d22155-6940-4585-8c94-77dbddb8b11d"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node4_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["0acbf204-eb20-4594-b984-ac9a16bdb516"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node5_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["a305ee94-1ccf-45c4-8418-1dfaddd2eb9d"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node6_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["ba092116-9834-43e6-822a-c656f194e9c9"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node7_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["a4911989-e9a2-4faf-9164-08b0fb05f937"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node8_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["f9c3c5ae-89a5-4df2-a8f5-eb580b3f97b5"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["5be1faa9-b4be-4358-b89e-3279c864305b"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["7e75b32d-e8ef-4187-a032-28a2b20a0691"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["30bc8bde-6bb6-4981-b3f5-df5ec4ebd446"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["7dc27ed6-9a50-46be-9dda-d3e7b040258a"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["cb239851-7953-446c-9c52-2c60ea224bc9"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["45e7ba27-4f5f-4e29-afc0-562a6c335cc1"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["4e5fa702-10bf-4d2b-9527-22ff71d2ff07"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node9_name):
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="prompt",
                node_name=node9_name,
                value=top_level_unique_values_dict["5a7bc4ae-03b0-4154-a0c9-74a54ff37ad5"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="input_images",
                node_name=node9_name,
                value=top_level_unique_values_dict["9d670339-5762-4adf-a45a-1f9359d6e781"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="human_images",
                node_name=node9_name,
                value=top_level_unique_values_dict["7b7257ba-95b8-48f0-bf5c-c80f95b6315e"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="aspect_ratio",
                node_name=node9_name,
                value=top_level_unique_values_dict["581c5698-ebbd-4f10-9ddb-ca58741768a8"],
                initial_setup=True,
                is_output=False,
            )
        )
