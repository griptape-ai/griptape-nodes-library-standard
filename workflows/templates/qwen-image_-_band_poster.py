...
# image = "https://raw.githubusercontent.com/griptape-ai/griptape-nodes-library-standard/main/workflows/templates/thumbnail_qwen-image_-_band_poster.webp"
#
# ///
...
top_level_unique_values_dict = {
    "8ef484bc-a910-40ec-a55e-46f68482a672": pickle.loads(
        b"\x80\x04\x95\x11\x00\x00\x00\x00\x00\x00\x00\x8c\rThe Capybaras\x94."
    ),
    "ba4efda3-109e-42f6-852e-b72f7dceb010": pickle.loads(
        b"\x80\x04\x95\t\x00\x00\x00\x00\x00\x00\x00\x8c\x051960s\x94."
    ),
    "a7205e3a-d10b-4343-86b9-7f1c9b025370": pickle.loads(
    ...
    "db8799fa-2063-4e99-9562-a712d8ff46ab": pickle.loads(
        b"\x80\x04\x95!\x00\x00\x00\x00\x00\x00\x00\x8c\x1dGenerate the Image using Qwen\x94."
    ),
    "d89fa857-8653-488a-96b5-d87dcab08908": pickle.loads(
        b"\x80\x04\x959\x00\x00\x00\x00\x00\x00\x00\x8c5# End Flow\n\nThe flow will return the resulting image.\x94."
    ),
    "400df2bb-997e-490b-8c33-fc5db425b73f": pickle.loads(
        b"\x80\x04\x95\x12\x00\x00\x00\x00\x00\x00\x00\x8c\x0egtc_qwen_image\x94."
    ),
    "189cb527-1ad4-4467-ae4a-defe3514b143": pickle.loads(
        b"\x80\x04\x95\r\x00\x00\x00\x00\x00\x00\x00\x8c\t1328*1328\x94."
    ),
    "99b85ff0-451f-46bb-8e76-73311ac095d7": pickle.loads(b"\x80\x04K*."),
    "043f4322-160e-4d09-9693-7086479a65a9": pickle.loads(
        b"\x80\x04\x95\xf9\x01\x00\x00\x00\x00\x00\x00X\xf2\x01\x00\x00# Qwen-Image - Band Poster\n\nthis workflow demonstrates the use of the image generation model [Qwen-Image](https://www.qwenimagen.com/) to create a mythical band poster based on a **band_name** and a **decade**.\n\nIt uses an agent with [OpenAI gpt-4.1-mini](https://platform.openai.com/docs/models/gpt-4.1-mini) to design an image generation prompt using some behavioal rules to ensure quality responses.\n\nModify the incoming values in the **Start Flow** node and run the workflow to see the results.\x94."
    ),
}
...
with GriptapeNodes.ContextManager().flow(flow0_name):
    node0_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -303.0843370080777, "y": 296.93529465485886},
    ...
    node1_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Agent_1",
            metadata={
                "position": {"x": 1405.5567786383533, "y": 296.93529465485886},
    ...
    with GriptapeNodes.ContextManager().node(node1_name):
        ...
        GriptapeNodes.handle_request(
            AlterParameterDetailsRequest(
                parameter_name="output_schema", ui_options={"hide_property": True, "hide": True}, initial_setup=True
            )
        )
    node2_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Ruleset_1",
            metadata={
                "position": {"x": 487.6351386036997, "y": 1104.4096152628408},
    ...
    node3_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 487.6351386036997, "y": 296.93529465485886},
    ...
    node4_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 1",
            metadata={
                "position": {"x": -303.0843370080777, "y": 66.8118912484619},
    ...
    node5_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 2",
            metadata={
                "position": {"x": 487.6351386036997, "y": 66.8118912484619},
    ...
    node6_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 3",
            metadata={
                "position": {"x": 487.6351386036997, "y": 890.6365870210909},
    ...
    node7_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 4",
            metadata={
                "position": {"x": 1405.5567786383533, "y": 66.8118912484619},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": NodeMetadata(
                    category="misc",
                    description="Create a note node to provide helpful context in your workflow",
    ...
    node8_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 5",
            metadata={
                "position": {"x": 2216.14914549015, "y": 66.8118912484619},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": NodeMetadata(
                    category="misc",
                    description="Create a note node to provide helpful context in your workflow",
    ...
    node9_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 6",
            metadata={
                "position": {"x": 3230.0044593220005, "y": 71.8118912484619},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": NodeMetadata(
                    category="misc",
                    description="Create a note node to provide helpful context in your workflow",
    ...
    node10_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            specific_library_name="Griptape Nodes Library",
            node_name="Qwen Image Generation",
            metadata={
                "library_node_metadata": NodeMetadata(
                    category="image",
                ...
                "library": "Griptape Nodes Library",
                "node_type": "QwenImageGeneration",
                "position": {"x": 2216.14914549015, "y": 296.93529465485886},
                "size": {"width": 719, "height": 1168},
                "showaddparameter": False,
                "category": "image",
            },
            initial_setup=True,
    ...
    node11_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -303.0843370080777, "y": -310.15782030394985},
                "tempId": "placing-1766071929871-sjsa8nk",
    ...
    node12_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "node_type": "EndFlow",
                "showaddparameter": True,
                "position": {"x": 3230.0044593220005, "y": 296.93529465485886},
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["8ef484bc-a910-40ec-a55e-46f68482a672"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="text_1",
                node_name=node0_name,
                value=top_level_unique_values_dict["ba4efda3-109e-42f6-852e-b72f7dceb010"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["a7205e3a-d10b-4343-86b9-7f1c9b025370"],
                initial_setup=True,
                is_output=True,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["f76f1e2f-d686-4e9a-835a-39205cc86e2d"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["1d0b600f-32ee-4e4a-bf32-f7a6cc3c5c1f"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["b6961639-71ba-4805-b295-37051bc697f4"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["2e3340f7-514b-470e-90ed-d7ab33bb5a37"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["b503e0df-f92f-4d87-a32b-42ab63522178"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="rulesets_ParameterListUniqueParamID_6df8ae9c0e1a4a1881fc4f3986fbab35",
                node_name=node1_name,
                value=top_level_unique_values_dict["d3b774c4-8264-4ffc-9abb-fb25fe7dad83"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["a4fe1814-6527-4049-bc7d-8acdbbb46b79"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="output",
                node_name=node1_name,
                value=top_level_unique_values_dict["81333882-790a-4fbc-8f23-fe49a3f3da69"],
                initial_setup=True,
                is_output=True,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["1547bac3-4fd7-4d6a-9d64-3b41486a1770"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="logs",
                node_name=node1_name,
                value=top_level_unique_values_dict["ccc66f39-2bcb-408d-9faf-c8e94defb1fd"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["e702e73f-0405-415e-bd36-7770d1736c02"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["e0311f55-6439-46ba-8ca0-00eac2c8f33c"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["f28322c8-a5e6-4232-be4c-e84f31fc03d4"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node3_name,
                value=top_level_unique_values_dict["cb0cea0a-2d3f-4aa1-9853-501ff9bfe450"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node3_name,
                value=top_level_unique_values_dict["d23d0b4f-f4c0-4cba-a099-850c62f8f158"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node4_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["f8c5865a-eeb8-460e-87b5-80408a287a38"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node5_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["6d47470d-e9d4-4d61-984e-ddd105d555cd"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node6_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["a343ac05-4f5d-41fe-94d7-33a306b7eb0d"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node7_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["40135bab-8eb7-4105-9fc5-d682eca19ef4"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node8_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["db8799fa-2063-4e99-9562-a712d8ff46ab"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node9_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["d89fa857-8653-488a-96b5-d87dcab08908"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node10_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["400df2bb-997e-490b-8c33-fc5db425b73f"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="size",
                node_name=node10_name,
                value=top_level_unique_values_dict["189cb527-1ad4-4467-ae4a-defe3514b143"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="seed",
                node_name=node10_name,
                value=top_level_unique_values_dict["99b85ff0-451f-46bb-8e76-73311ac095d7"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node11_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["043f4322-160e-4d09-9693-7086479a65a9"],
                initial_setup=True,
                is_output=False,
            )
        )
