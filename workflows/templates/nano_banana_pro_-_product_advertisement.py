...
# image = "https://raw.githubusercontent.com/griptape-ai/griptape-nodes-library-standard/main/workflows/templates/thumbnail_nano_banana_pro_-_product_advertisement.webp"
#
# ///
...
top_level_unique_values_dict = {
    ...
    "f3269543-6788-45b8-960b-18d318350057": pickle.loads(
        b"\x80\x04\x95\x96\x01\x00\x00\x00\x00\x00\x00\x8c%griptape.artifacts.image_url_artifact\x94\x8c\x10ImageUrlArtifact\x94\x93\x94)\x81\x94}\x94(\x8c\x04type\x94\x8c\x10ImageUrlArtifact\x94\x8c\x0bmodule_name\x94\x8c%griptape.artifacts.image_url_artifact\x94\x8c\x02id\x94\x8c b151759914d6498795123ed7031c6d77\x94\x8c\treference\x94N\x8c\x04meta\x94}\x94\x8c\x04name\x94\x8c\x1fgoogle_image_1766024834_0_0.jpg\x94\x8c\x16encoding_error_handler\x94\x8c\x06strict\x94\x8c\x08encoding\x94\x8c\x05utf-8\x94\x8c\x05value\x94\x8cYhttp://localhost:8124/workspace/static_files/google_image_1766024834_0_0.jpg?t=1766024834\x94ub."
    ),
    "1bc06796-15eb-46c3-9690-1fa94cc0860a": pickle.loads(
        b"\x80\x04\x95\x0b\x00\x00\x00\x00\x00\x00\x00\x8c\x07product\x94."
    ),
    "d944f8f2-fe76-4789-abf0-3a1089b3fd36": pickle.loads(
        b"\x80\x04\x95\x1c\x00\x00\x00\x00\x00\x00\x00}\x94\x8c\x07product\x94\x8c\x0bsalt shaker\x94s."
    ),
    "63d5722c-85a7-4d8c-a464-0ae8486cbcaf": pickle.loads(
        b"\x80\x04\x95\x1c\x00\x00\x00\x00\x00\x00\x00}\x94\x8c\x07product\x94\x8c\x0bsalt shaker\x94s."
    ),
    "1f5b3f38-a795-4d13-8301-0ddc257da915": pickle.loads(
        b"\x80\x04\x95\x0b\x00\x00\x00\x00\x00\x00\x00\x8c\x07company\x94."
    ),
    "6d3acf14-a6b3-4ed9-b283-270f2004f141": pickle.loads(
        b"\x80\x04\x95!\x00\x00\x00\x00\x00\x00\x00}\x94\x8c\x07company\x94\x8c\x10concrete kitchen\x94s."
    ),
    "dea2fe9c-0b5d-4f5d-b14e-df0c48b7d70f": pickle.loads(
        b"\x80\x04\x95!\x00\x00\x00\x00\x00\x00\x00}\x94\x8c\x07company\x94\x8c\x10concrete kitchen\x94s."
    ),
    "909f0d29-505d-482b-9b11-7d43411df79f": pickle.loads(
        b"\x80\x04\x95\x17\x00\x00\x00\x00\x00\x00\x00\x8c\x13company description\x94."
    ),
    "6453a546-a5e6-4fac-ae0e-e2c17a98bb41": pickle.loads(
        b"\x80\x04\x95H\x00\x00\x00\x00\x00\x00\x00}\x94\x8c\x13company description\x94\x8c+a gritty punk rock kitchen hardware company\x94s."
    ),
    "7cca220f-25b6-4df7-bb9d-8fb55020762b": pickle.loads(
        b"\x80\x04\x95H\x00\x00\x00\x00\x00\x00\x00}\x94\x8c\x13company description\x94\x8c+a gritty punk rock kitchen hardware company\x94s."
    ),
    "3d312138-aa71-4616-9eb9-1d6fd25a4b7c": pickle.loads(
        b"\x80\x04\x95\x1e\x00\x00\x00\x00\x00\x00\x00\x8c\x1a{'product': 'salt shaker'}\x94."
    ),
    "b944f1ee-c85a-4026-8582-1b333b4d8f93": pickle.loads(
        b"\x80\x04\x95#\x00\x00\x00\x00\x00\x00\x00\x8c\x1f{'company': 'concrete kitchen'}\x94."
    ),
    "f76edcad-2ad0-4f4b-8443-cf3b7250ff8e": pickle.loads(
        b"\x80\x04\x95J\x00\x00\x00\x00\x00\x00\x00\x8cF{'company description': 'a gritty punk rock kitchen hardware company'}\x94."
    ),
    "014e3451-8116-4d3b-b6a5-27728b1680d1": pickle.loads(
        b"\x80\x04\x95\x06\x00\x00\x00\x00\x00\x00\x00\x8c\x02\\n\x94."
    ),
    "466ae656-9659-4677-aea4-b1f697b7f579": pickle.loads(
        b"\x80\x04\x95O\x02\x00\x00\x00\x00\x00\x00XH\x02\x00\x00# Nano Banana Pro - Product Advertisement\n\nThis workflow demonstrates the use of the image generation model Google Gemini [Nano Banana Pro](https://gemini.google/overview/image-generation/) to create a product advertisement based on a **product**, a **company name** and a **company description**\n\nIt uses an agent with [OpenAI gpt-4.1-mini](https://platform.openai.com/docs/models/gpt-4.1-mini) to design an image generation prompt using some behavioal rules to ensure quality responses.\n\nModify the incoming values in the **Start Flow** node and run the workflow to see the results.\x94."
    ),
    "41381fe3-1608-4a95-9fbc-04ab7f2ef7f2": pickle.loads(
        b"\x80\x04\x95p\x00\x00\x00\x00\x00\x00\x00\x8cl# Inputs\n\nProvide a *product*, *company name*, and *company description* to create an add for their product.\x94."
    ),
    "cacef36a-e4a1-45b3-ade0-286fddda0a6a": pickle.loads(
        b"\x80\x04\x95G\x00\x00\x00\x00\x00\x00\x00\x8cCUse Key/Value pair nodes to gather the appropriate text and values.\x94."
    ),
    "82c46660-aef4-4bfb-bd55-c8aba8a58863": pickle.loads(
        b"\x80\x04\x95H\x00\x00\x00\x00\x00\x00\x00\x8cD# Merge Text\n\nMerge all the key value pairs into a single text node.\x94."
    ),
    "c65612f3-a402-402c-b0a8-55b97b44122e": pickle.loads(
        b"\x80\x04\x95\x95\x00\x00\x00\x00\x00\x00\x00\x8c\x91Using Agents to create image generation prompts helps ensure consistency in the prompt, and allows you to be a bit more free with how you prompt.\x94."
    ),
    "64686c6e-4200-4760-98ef-beee2ff7fc17": pickle.loads(
        b"\x80\x04\x95\xb4\x00\x00\x00\x00\x00\x00\x00\x8c\xb0# Agent Behavior\n\nThere are many rules on the internet with best practices for using Nano Banana. Here are some that appear to work well, but feel free to extend with your own.\x94."
    ),
    "5293bebc-b569-479c-8738-b3ce9616082c": pickle.loads(
        b"\x80\x04\x95,\x00\x00\x00\x00\x00\x00\x00\x8c(Generate the Image using Nano Banana Pro\x94."
    ),
    "204b1a64-14a3-4ef4-b751-0fd71c2681a4": pickle.loads(
        b"\x80\x04\x95$\x00\x00\x00\x00\x00\x00\x00\x8c Run the flow and see the results\x94."
    ),
    "ed15b4d7-2975-4ead-81e2-ce8487db26c5": pickle.loads(
        b"\x80\x04\x95\x1a\x00\x00\x00\x00\x00\x00\x00\x8c\x16gtc_gemini_3_pro_image\x94."
    ),
    "fc16b473-5af6-476a-b2e3-22e3b9a870c5": pickle.loads(b"\x80\x04]\x94."),
    "625901d3-2fb8-4d5e-ba92-cd8e24591291": pickle.loads(b"\x80\x04]\x94."),
    "92852550-f440-4c3a-a915-6c22687ab9d5": pickle.loads(b"\x80\x04]\x94."),
    "884708c8-9ec1-43e6-83b8-34d8e8e9c0b4": pickle.loads(
        b"\x80\x04\x95\x07\x00\x00\x00\x00\x00\x00\x00\x8c\x031:1\x94."
    ),
    "4817eaf8-c076-4d42-90b5-95e19e85fb27": pickle.loads(
        b"\x80\x04\x95\x06\x00\x00\x00\x00\x00\x00\x00\x8c\x021K\x94."
    ),
    "a27c0f48-dec1-4beb-bf29-7038c1c1eac5": pickle.loads(
...
with GriptapeNodes.ContextManager().flow(flow0_name):
    node0_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -1061.5751704894092, "y": 508.4577249729338},
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                ...
                default_value="salt shaker",
                tooltip="Enter text/string for product.",
                type="str",
                input_types=["str"],
                output_type="str",
        ...
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                ...
                default_value="rocks 'n things",
                tooltip="Enter text/string for company_name.",
                type="str",
                input_types=["str"],
                output_type="str",
                ui_options={"is_custom": True, "is_user_added": True},
        ...
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                ...
                default_value="gritty downtown coffee and kitchen supply",
                tooltip="Enter text/string for company_description.",
                type="str",
                input_types=["str"],
                output_type="str",
                ui_options={"is_custom": True, "is_user_added": True},
    ...
    node1_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Agent_1",
            metadata={
                "position": {"x": 1979.6649600863996, "y": 547.3773674509565},
                "tempId": "placing-1765998525786-f45x3l",
                "library_node_metadata": {
                    "category": "agents",
    ...
    with GriptapeNodes.ContextManager().node(node1_name):
        ...
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                parameter_name="rulesets_ParameterListUniqueParamID_6df8ae9c0e1a4a1881fc4f3986fbab35",
                default_value=[],
        ...
        GriptapeNodes.handle_request(
            AlterParameterDetailsRequest(
                parameter_name="output_schema", ui_options={"hide_property": True, "hide": False}, initial_setup=True
            )
        )
    node2_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Ruleset_1",
            metadata={
                "position": {"x": 1002.176604440061, "y": 1364.3254929749025},
                "tempId": "placing-1765998085117-ktqra",
                "library_node_metadata": {
    ...
    node3_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "node_type": "EndFlow",
                "showaddparameter": True,
                "position": {"x": 3771.5455086365287, "y": 547.3773674509565},
    ...
    node4_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -2.600081988967247, "y": 200.82104236312074},
                "tempId": "placing-1766023727118-f3seci",
    ...
    node5_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -2.600081988967247, "y": 508.4577249729338},
                "tempId": "placing-1766023727118-f3seci",
                "library_node_metadata": {"category": "dict", "description": "Create a Key Value Pair"},
                "library": "Griptape Nodes Library",
                "node_type": "KeyValuePair",
    ...
    node6_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            node_type="KeyValuePair",
            specific_library_name="Griptape Nodes Library",
            node_name="Key Value Pair_2",
            metadata={
                "position": {"x": -2.600081988967247, "y": 759.8078514129766},
                "tempId": "placing-1766023727118-f3seci",
                "library_node_metadata": {"category": "dict", "description": "Create a Key Value Pair"},
                "library": "Griptape Nodes Library",
                "node_type": "KeyValuePair",
    ...
    node7_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": 1002.176604440061, "y": 547.3773674509565},
                "tempId": "placing-1766024416994-ze2v3r",
                "library_node_metadata": {"category": "text", "description": "MergeTexts node"},
                "library": "Griptape Nodes Library",
                "node_type": "MergeTexts",
                "showaddparameter": False,
                "size": {"width": 600, "height": 428},
                "category": "text",
    ...
    with GriptapeNodes.ContextManager().node(node7_name):
        GriptapeNodes.handle_request(
            AlterParameterDetailsRequest(
                ...
                ui_options={"placeholder_text": "Input 4", "hide_label": False, "hide_property": False, "hide": True},
                initial_setup=True,
            )
        )
        GriptapeNodes.handle_request(
    ...
    node8_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -1061.5751704894092, "y": -428.097932950298},
                "tempId": "placing-1766075246290-tahpkl",
                "library_node_metadata": {
                    "category": "misc",
    ...
    node9_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 1",
            metadata={
                "position": {"x": -1061.5751704894092, "y": 279.80785141297656},
    ...
    node10_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 2",
            metadata={
                "position": {"x": -2.600081988967247, "y": 39.377367450956484},
    ...
    node11_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 3",
            metadata={
                "position": {"x": 1002.176604440061, "y": 316.4577249729338},
                "tempId": "placing-1766024634893-vx3o39",
                "library_node_metadata": {
                    "category": "misc",
                    "description": "Create a note node to provide helpful context in your workflow",
                },
    ...
    node12_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 5",
            metadata={
                "position": {"x": 1979.6649600863996, "y": 316.4577249729338},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": {
                    "category": "misc",
                    "description": "Create a note node to provide helpful context in your workflow",
    ...
    node13_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 4",
            metadata={
                "position": {"x": 1002.176604440061, "y": 1138.449558862941},
                "tempId": "placing-1766003265679-b4mek",
                "library_node_metadata": {
                    "category": "misc",
                    "description": "Create a note node to provide helpful context in your workflow",
                },
    ...
    node14_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 6",
            metadata={
                "position": {"x": 2802.6192263139055, "y": 316.4577249729338},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": {
                    "category": "misc",
                    "description": "Create a note node to provide helpful context in your workflow",
    ...
    node15_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 7",
            metadata={
                "position": {"x": 3771.5455086365287, "y": 316.4577249729338},
                "tempId": "placing-1766075761957-uyggs",
                "library_node_metadata": {
                    "category": "misc",
                    "description": "Create a note node to provide helpful context in your workflow",
                },
    ...
    node16_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "library": "Griptape Nodes Library",
                "node_type": "GoogleImageGeneration",
                "position": {"x": 2802.6192263139055, "y": 547.3773674509565},
                "size": {"width": 750, "height": 1303},
            },
            initial_setup=True,
        )
    ).node_name
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            target_parameter_name="rulesets_ParameterListUniqueParamID_6df8ae9c0e1a4a1881fc4f3986fbab35",
            initial_setup=True,
        )
    )
    GriptapeNodes.handle_request(
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            source_node_name=node0_name,
            source_parameter_name="company_name",
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            source_node_name=node0_name,
            source_parameter_name="company_description",
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["10bf13cc-b477-4d90-b129-8b1532a821fe"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="company_name",
                node_name=node0_name,
                value=top_level_unique_values_dict["89092bc7-aca0-4f69-a67e-dd56aa25e810"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="company_description",
                node_name=node0_name,
                value=top_level_unique_values_dict["7268fb5e-d50b-441b-bc86-f6582068992f"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["85ffb073-434b-43a3-b8d3-f1e93e539bc2"],
                initial_setup=True,
                is_output=True,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["0e0fed8c-49a3-4023-898e-2349b77b4580"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["e70b0b9a-e60c-4d62-979c-b0ff28978400"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["ea4889b1-8247-42ee-8fb6-156a9b471ea7"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["77017d67-1b59-492d-80cb-e3d3b49ae7a4"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["84a8ec28-c0a3-4a09-9dfe-0ec753941cab"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="rulesets_ParameterListUniqueParamID_6df8ae9c0e1a4a1881fc4f3986fbab35",
                node_name=node1_name,
                value=top_level_unique_values_dict["733f2dc7-d115-4fa6-af0f-5d725d97a7b9"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["f4360ed4-8b55-48e8-8be0-214d7fac382c"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="output",
                node_name=node1_name,
                value=top_level_unique_values_dict["b7ea98f1-a788-4568-80ec-c16119a5c2f5"],
                initial_setup=True,
                is_output=True,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["9d65cda2-ace4-40d5-acd2-8ba4054a66f9"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="logs",
                node_name=node1_name,
                value=top_level_unique_values_dict["de79206b-d7ff-4a16-8565-99c746c81782"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["a835f448-d967-47df-9b8b-f8035f829e82"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["cf32a276-0356-4e52-b8f3-4d703f5e649f"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["e44a855e-9d77-4f7f-aa51-9ff55df9d8e6"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node3_name,
                value=top_level_unique_values_dict["731fde86-d9bf-43e9-8e5c-d41972e27307"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="image",
                node_name=node3_name,
                value=top_level_unique_values_dict["f3269543-6788-45b8-960b-18d318350057"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node4_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["1bc06796-15eb-46c3-9690-1fa94cc0860a"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="dictionary",
                node_name=node4_name,
                value=top_level_unique_values_dict["d944f8f2-fe76-4789-abf0-3a1089b3fd36"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="dictionary",
                node_name=node4_name,
                value=top_level_unique_values_dict["63d5722c-85a7-4d8c-a464-0ae8486cbcaf"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node5_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["1f5b3f38-a795-4d13-8301-0ddc257da915"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="dictionary",
                node_name=node5_name,
                value=top_level_unique_values_dict["6d3acf14-a6b3-4ed9-b283-270f2004f141"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="dictionary",
                node_name=node5_name,
                value=top_level_unique_values_dict["dea2fe9c-0b5d-4f5d-b14e-df0c48b7d70f"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node6_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["909f0d29-505d-482b-9b11-7d43411df79f"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="dictionary",
                node_name=node6_name,
                value=top_level_unique_values_dict["6453a546-a5e6-4fac-ae0e-e2c17a98bb41"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="dictionary",
                node_name=node6_name,
                value=top_level_unique_values_dict["7cca220f-25b6-4df7-bb9d-8fb55020762b"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node7_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["3d312138-aa71-4616-9eb9-1d6fd25a4b7c"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node7_name,
                value=top_level_unique_values_dict["b944f1ee-c85a-4026-8582-1b333b4d8f93"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node7_name,
                value=top_level_unique_values_dict["f76edcad-2ad0-4f4b-8443-cf3b7250ff8e"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node7_name,
                value=top_level_unique_values_dict["014e3451-8116-4d3b-b6a5-27728b1680d1"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node8_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["466ae656-9659-4677-aea4-b1f697b7f579"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node9_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["41381fe3-1608-4a95-9fbc-04ab7f2ef7f2"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node10_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["cacef36a-e4a1-45b3-ade0-286fddda0a6a"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node11_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["82c46660-aef4-4bfb-bd55-c8aba8a58863"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node12_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["c65612f3-a402-402c-b0a8-55b97b44122e"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node13_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["64686c6e-4200-4760-98ef-beee2ff7fc17"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node14_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["5293bebc-b569-479c-8738-b3ce9616082c"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node15_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["204b1a64-14a3-4ef4-b751-0fd71c2681a4"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node16_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["ed15b4d7-2975-4ead-81e2-ce8487db26c5"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node16_name,
                value=top_level_unique_values_dict["fc16b473-5af6-476a-b2e3-22e3b9a870c5"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node16_name,
                value=top_level_unique_values_dict["625901d3-2fb8-4d5e-ba92-cd8e24591291"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node16_name,
                value=top_level_unique_values_dict["92852550-f440-4c3a-a915-6c22687ab9d5"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node16_name,
                value=top_level_unique_values_dict["884708c8-9ec1-43e6-83b8-34d8e8e9c0b4"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node16_name,
                value=top_level_unique_values_dict["4817eaf8-c076-4d42-90b5-95e19e85fb27"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node16_name,
                value=top_level_unique_values_dict["a27c0f48-dec1-4beb-bf29-7038c1c1eac5"],
                initial_setup=True,
                is_output=False,
            )
        )
