...
# last_modified_date = 2026-01-28T00:08:59.605359Z
...
# image = "https://raw.githubusercontent.com/griptape-ai/griptape-nodes-library-standard/main/workflows/templates/thumbnail_flux_2_-_magazine_cover.webp"
#
# ///
...
top_level_unique_values_dict = {
    ...
    "f4724f1e-2067-44a0-a352-f5b88a29fc35": pickle.loads(
        b"\x80\x04\x95\x17\x00\x00\x00\x00\x00\x00\x00\x8c\x13gtc_flux_2_klein_9b\x94."
    ),
    "3dd02633-3340-44ef-a325-7a5a422ffd80": pickle.loads(b"\x80\x04]\x94."),
    "8dac347a-079c-4ccb-9cde-e7c6c8f1fb9b": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00M\x80\x03."),
    "9ee3f311-6725-4d84-942e-989b6f2254d7": pickle.loads(b"\x80\x04\x95\x04\x00\x00\x00\x00\x00\x00\x00M\x80\x04."),
    "8d64c5cf-c037-40b3-8416-b09d1da22819": pickle.loads(b"\x80\x04K*."),
    "8c8aac24-cb64-4b21-a6bb-60875da625bd": pickle.loads(
        b"\x80\x04\x95\x08\x00\x00\x00\x00\x00\x00\x00\x8c\x04jpeg\x94."
    ),
    "d6e5dcf3-8f91-48bd-bf2f-8334bbb8748f": pickle.loads(
        b"\x80\x04\x95\x15\x00\x00\x00\x00\x00\x00\x00\x8c\x11least restrictive\x94."
    ),
    "38a6d2ec-1b89-4883-ad1f-b3f98dba9b32": pickle.loads(b"\x80\x04K2."),
    "c23a47f2-b8d4-4fcd-8634-c5ab6004d7e8": pickle.loads(
...
with GriptapeNodes.ContextManager().flow(flow0_name):
    node0_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -1061.5751704894092, "y": 296.93529465485886},
    ...
    node1_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Ruleset_1",
            metadata={
                "position": {"x": -140.8654069738245, "y": 1134.5360838384356},
    ...
    node2_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -140.8654069738245, "y": 258.80785141297656},
                "tempId": "placing-1766002459782-pzdym9",
                "library_node_metadata": NodeMetadata(
                    category="text",
    ...
    node3_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                "position": {"x": -1061.5751704894092, "y": -336.52399023132017},
                "tempId": "placing-1766158799711-dw55dh",
                "library_node_metadata": NodeMetadata(
                    category="misc",
    ...
    node4_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 1",
            metadata={
                "position": {"x": -1061.5751704894092, "y": 66.80785141297656},
    ...
    node5_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 2",
            metadata={
                "position": {"x": -140.8654069738245, "y": 66.80785141297656},
    ...
    node6_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 3",
            metadata={
                "position": {"x": -140.8654069738245, "y": 924.8103879646247},
    ...
    node7_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 4",
            metadata={
                "position": {"x": 973.7080171132445, "y": 66.80785141297656},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": NodeMetadata(
                    category="misc",
                    description="Create a note node to provide helpful context in your workflow",
    ...
    node8_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "library": "Griptape Nodes Library",
                "node_type": "Agent",
                "position": {"x": 973.7080171132445, "y": 258.80785141297656},
                "size": {"width": 600, "height": 1179},
            },
            initial_setup=True,
        )
    ).node_name
    with GriptapeNodes.ContextManager().node(node8_name):
        ...
        GriptapeNodes.handle_request(
            AddParameterToNodeRequest(
                parameter_name="rulesets_ParameterListUniqueParamID_cfcb1fdadf364b38b44e1e31d82555ad",
                default_value=[],
    ...
    node9_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 5",
            metadata={
                "position": {"x": 1863.852786603357, "y": 66.80785141297656},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": NodeMetadata(
                    category="misc",
                    description="Create a note node to provide helpful context in your workflow",
    ...
    node10_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="Step 8",
            metadata={
                "position": {"x": 2755.9261113966577, "y": 66.80785141297656},
                "tempId": "placing-1766003370124-fo9hq",
                "library_node_metadata": NodeMetadata(
                    category="misc",
                    description="Create a note node to provide helpful context in your workflow",
    ...
    node11_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "node_type": "EndFlow",
                "showaddparameter": True,
                "position": {"x": 2755.9261113966577, "y": 258.80785141297656},
    ...
    node12_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            metadata={
                ...
                "library": "Griptape Nodes Library",
                "node_type": "Flux2ImageGeneration",
                "position": {"x": 1859.9823765949673, "y": 258.80785141297656},
                "size": {"width": 725, "height": 1245},
            },
            initial_setup=True,
        )
    ).node_name
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            source_node_name=node0_name,
            source_parameter_name="text_1",
            target_node_name=node2_name,
            target_parameter_name="input_4",
            initial_setup=True,
        )
    )
    GriptapeNodes.handle_request(
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            target_node_name=node8_name,
            target_parameter_name="rulesets_ParameterListUniqueParamID_cfcb1fdadf364b38b44e1e31d82555ad",
            initial_setup=True,
        )
    )
    GriptapeNodes.handle_request(
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["f3f12cbd-f919-4d7d-b3ea-a28b6cc2e339"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="text_1",
                node_name=node0_name,
                value=top_level_unique_values_dict["eaa8f399-b5fe-47d9-a300-d4029db7a87e"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["cff8df73-942b-4ea7-9905-e963a62d03b6"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["5822813d-7fa8-44f3-884e-3680c1d2a1a7"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node1_name,
                value=top_level_unique_values_dict["f0581d92-abac-43f7-9f4b-943423c225f6"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["646a0446-68f1-4777-b59d-951032a9bd63"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["2cc72bdb-85bb-4964-985a-b948fab37e98"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["b1df7632-597f-4698-ba9b-319fade08f33"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["8d19bd92-e181-4427-ab18-80eb5d5bc7d5"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["e94d7487-b0f1-4106-8bfb-a412e3c9f25f"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node3_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["54fe89f9-c8f0-42f3-a60f-70dd0914e011"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node4_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["123e6ca9-f049-44a0-9a00-790df7eaccfd"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node5_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["894f7b6a-94d7-4756-a52e-875b6354910e"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node6_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["e390ca46-706f-4b52-bd9a-e4e7d7d5a596"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node7_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["4343678d-18fc-4735-9268-0fff92ada79c"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node8_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["00711031-d13c-4f67-8d64-ead22c90813b"],
                initial_setup=True,
                is_output=True,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["3583adce-40cd-4d68-826c-240ef785b476"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["1ab2d601-3bee-47c0-a312-4ee184df04cc"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["52b52082-2144-4673-a14f-69dd49c6a416"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["495df5d4-ac46-4d4d-ac64-4a68d43c0e32"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node8_name,
                value=top_level_unique_values_dict["305ecfa9-a145-4acd-910c-2f83a91593aa"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="output",
                node_name=node8_name,
                value=top_level_unique_values_dict["e6df1fdc-d27e-42e9-8fc3-e9d2e3661f0a"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="output",
                node_name=node8_name,
                value=top_level_unique_values_dict["f383f6af-7263-4e40-bd5c-edec67eb1e6c"],
                initial_setup=True,
                is_output=True,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="logs",
                node_name=node8_name,
                value=top_level_unique_values_dict["91822bfd-b8ce-42b9-9464-a0bf0f46942c"],
                initial_setup=True,
                is_output=True,
            )
        )
    with GriptapeNodes.ContextManager().node(node9_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["bf3afb03-2f20-4148-8f0f-4eb95370b6c5"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node10_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["a357f877-d8e1-4702-b3a2-d1835c4e665a"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node11_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["583ee02c-bff3-47d0-813b-fc9eff5f661d"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node11_name,
                value=top_level_unique_values_dict["b0a13b1b-3f62-4f63-9845-ace19dc50c2b"],
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(node12_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["f4724f1e-2067-44a0-a352-f5b88a29fc35"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["3dd02633-3340-44ef-a325-7a5a422ffd80"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["8dac347a-079c-4ccb-9cde-e7c6c8f1fb9b"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["9ee3f311-6725-4d84-942e-989b6f2254d7"],
                initial_setup=True,
                is_output=False,
            )
        )
        ...
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="seed",
                node_name=node12_name,
                value=top_level_unique_values_dict["8d64c5cf-c037-40b3-8416-b09d1da22819"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["8c8aac24-cb64-4b21-a6bb-60875da625bd"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["d6e5dcf3-8f91-48bd-bf2f-8334bbb8748f"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["38a6d2ec-1b89-4883-ad1f-b3f98dba9b32"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node12_name,
                value=top_level_unique_values_dict["c23a47f2-b8d4-4fcd-8634-c5ab6004d7e8"],
                initial_setup=True,
                is_output=False,
            )
        )
