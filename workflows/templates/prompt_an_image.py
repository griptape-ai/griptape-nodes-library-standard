...
top_level_unique_values_dict = {
    "72192d95-1fc6-41d0-8185-567f99a58900": pickle.loads(
    ...
    "33698c31-14e1-48dc-9332-7d7f6080470a": pickle.loads(
    ...
    "368c415d-9242-4857-9519-00b24d91f560": pickle.loads(
        b"\x80\x04\x95\r\x00\x00\x00\x00\x00\x00\x00\x8c\t1024x1024\x94."
    ),
    "5aa10d7e-2be0-4717-be51-ded5ac6c0582": pickle.loads(b"\x80\x04\x89."),
}
...
with GriptapeNodes.ContextManager().flow(flow0_name):
    ...
    node1_name = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="NextStep",
            metadata={
                "position": {"x": 682.7362228623616, "y": 724.9826304547828},
    ...
    with GriptapeNodes.ContextManager().node(node0_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["72192d95-1fc6-41d0-8185-567f99a58900"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node1_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["33698c31-14e1-48dc-9332-7d7f6080470a"],
                initial_setup=True,
                is_output=False,
            )
        )
    with GriptapeNodes.ContextManager().node(node2_name):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value=top_level_unique_values_dict["35b654a4-afe9-4084-b1a5-437522aed294"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["f46443d1-82b3-4c12-abc8-07b4801133d3"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="image_size",
                node_name=node2_name,
                value=top_level_unique_values_dict["368c415d-9242-4857-9519-00b24d91f560"],
                initial_setup=True,
                is_output=False,
            )
        )
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=node2_name,
                value=top_level_unique_values_dict["5aa10d7e-2be0-4717-be51-ded5ac6c0582"],
                initial_setup=True,
                is_output=False,
            )
        )
