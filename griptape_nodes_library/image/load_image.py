...
class LoadImage(SuccessFailureNode):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        if mask_output_file_param := self.get_parameter_by_name("mask_output_file"):
            mask_output_file_param.update_ui_options_key("hide", True)
    ...
    def _extract_channel_as_mask(self, image_artifact: ImageUrlArtifact, channel: str) -> None:
        ...
        try:
            ...
            dest = self._mask_output_file.build_file()
