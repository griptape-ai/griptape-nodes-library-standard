...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_elevenlabs_text_to_speech_generation"
...
with GriptapeNodes.ContextManager().flow(flow_name):
    gen_node = GriptapeNodes.handle_request(CreateNodeRequest(
        ...
        node_name="ElevenLabsTextToSpeechGeneration", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
    ...
    with GriptapeNodes.ContextManager().node(start_node):
        GriptapeNodes.handle_request(SetParameterValueRequest(
            ...
            value="Hello world", initial_setup=True, is_output=False))
