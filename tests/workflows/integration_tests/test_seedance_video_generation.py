...
with GriptapeNodes.ContextManager().flow(flow_name):
    gen_node = GriptapeNodes.handle_request(CreateNodeRequest(
        node_type="SeedanceVideoGeneration", specific_library_name="Griptape Nodes Library",
        node_name="SeedanceVideoGeneration", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
