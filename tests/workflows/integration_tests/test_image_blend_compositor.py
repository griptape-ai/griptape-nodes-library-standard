...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_image_blend_compositor"
...
with GriptapeNodes.ContextManager().flow(flow_name):
    source_node_1 = GriptapeNodes.handle_request(CreateNodeRequest(
        ...
        node_name="Create Color Bars 1", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
    source_node_2 = GriptapeNodes.handle_request(CreateNodeRequest(
        node_type="CreateColorBars", specific_library_name="Griptape Nodes Library",
        node_name="Create Color Bars 2", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
    gen_node = GriptapeNodes.handle_request(CreateNodeRequest(
        ...
        node_name="ImageBlendCompositor", metadata={}, resolution="resolved", initial_setup=True,
    )).node_name
