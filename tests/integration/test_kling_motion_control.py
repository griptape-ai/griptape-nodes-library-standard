...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_kling_motion_control"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "GenerateImage"], ["Griptape Nodes Library", "KlingMotionControl"], ["Griptape Nodes Library", "LTXTextToVideoGeneration"], ["Griptape Nodes Library", "ToText"]]
    ...
    with GriptapeNodes.ContextManager().node(source_node):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                value="Full body photo of one person standing, plain background",
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    with GriptapeNodes.ContextManager().node(ltx_node):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="prompt",
                node_name=ltx_node,
                value="A person waving both arms, full body, fixed camera",
                initial_setup=True,
                is_output=False,
            )
        )
