...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_veo3_video_generation_two_samples"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "ToText"], ["Griptape Nodes Library", "Veo3VideoGeneration"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    ...
    with GriptapeNodes.ContextManager().node(gen_node):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="sample_count", node_name=gen_node, value=2, initial_setup=True, is_output=False
            )
        )
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            source_node_name=gen_node,
            source_parameter_name="video_url_2",
