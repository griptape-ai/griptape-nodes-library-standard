...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_world_labs_world_generation"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "ToText"], ["Griptape Nodes Library", "WorldLabsWorldGeneration"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    gen_node = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            node_name="WorldLabsWorldGeneration",
            metadata={},
            initial_setup=True,
        )
    ).node_name
    ...
    with GriptapeNodes.ContextManager().node(gen_node):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                ...
                node_name=gen_node,
                value="A quiet garden courtyard",
                initial_setup=True,
                is_output=False,
            )
        )
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            source_parameter_name="splat_100k",
