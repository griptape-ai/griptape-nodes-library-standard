...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_wan_reference_to_video_generation"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "LTXTextToVideoGeneration"], ["Griptape Nodes Library", "WanReferenceToVideoGeneration"], ["Griptape Nodes Library", "ToText"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    ...
    gen_node = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            specific_library_name="Griptape Nodes Library",
            node_name="WanReferenceToVideoGeneration",
            metadata={},
            initial_setup=True,
        )
    ).node_name
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            target_parameter_name="reference_video_1",
            initial_setup=True,
        )
    )
