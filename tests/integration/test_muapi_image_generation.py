...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_muapi_image_generation"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "MuapiImageGeneration"], ["Griptape Nodes Library", "StartFlow"], ["Griptape Nodes Library", "ToText"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    gen_node = GriptapeNodes.handle_request(
        CreateNodeRequest(
            node_type="MuapiImageGeneration",
            specific_library_name="Griptape Nodes Library",
            node_name="MuapiImageGeneration",
            metadata={},
            resolution="resolved",
            initial_setup=True,
        )
