...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_seedance_2_5_last_frame_artifact"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "Seedance25VideoGeneration"], ["Griptape Nodes Library", "ToText"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    ...
    with GriptapeNodes.ContextManager().node(gen_node):
        GriptapeNodes.handle_request(
            SetParameterValueRequest(
                parameter_name="return_last_frame", node_name=gen_node, value=True, initial_setup=True, is_output=False
            )
        )
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            source_node_name=gen_node,
            source_parameter_name="last_frame_url",
