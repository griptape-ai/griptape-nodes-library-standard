...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_kling_omni_video_generation"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "KlingOmniVideoGeneration"], ["Griptape Nodes Library", "StartFlow"], ["Griptape Nodes Library", "ToText"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    gen_node = GriptapeNodes.handle_request(
        CreateNodeRequest(
            node_type="KlingOmniVideoGeneration",
            specific_library_name="Griptape Nodes Library",
            node_name="KlingOmniVideoGeneration",
            metadata={},
            initial_setup=True,
        )
    ).node_name
