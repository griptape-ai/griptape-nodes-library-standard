...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_cartwheel_character_generation"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "CartwheelCharacterGeneration"], ["Griptape Nodes Library", "StartFlow"], ["Griptape Nodes Library", "ToText"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    gen_node = GriptapeNodes.handle_request(
        CreateNodeRequest(
            node_type="CartwheelCharacterGeneration",
            specific_library_name="Griptape Nodes Library",
            node_name="CartwheelCharacterGeneration",
            metadata={},
            resolution="resolved",
            initial_setup=True,
        )
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            source_parameter_name="thumbnail_image",
