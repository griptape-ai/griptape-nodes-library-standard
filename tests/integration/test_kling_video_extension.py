...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_kling_video_extension"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "KlingTextToVideoGeneration"], ["Griptape Nodes Library", "KlingVideoExtension"], ["Griptape Nodes Library", "ToText"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            source_parameter_name="kling_video_id",
            target_node_name=gen_node,
            target_parameter_name="video_id",
            initial_setup=True,
        )
    )
