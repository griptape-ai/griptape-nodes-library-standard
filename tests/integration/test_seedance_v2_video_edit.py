...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_seedance_v2_video_edit"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "LTXTextToVideoGeneration"], ["Griptape Nodes Library", "SeedanceVideoGeneration"], ["Griptape Nodes Library", "ToText"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    ...
    GriptapeNodes.handle_request(
        CreateConnectionRequest(
            ...
            target_parameter_name="video_input",
            initial_setup=True,
        )
    )
    GriptapeNodes.handle_request(
