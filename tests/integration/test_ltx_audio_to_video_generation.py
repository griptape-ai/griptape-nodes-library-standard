...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_ltx_audio_to_video_generation"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "ElevenLabsTextToSpeechGeneration"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "LTXAudioToVideoGeneration"], ["Griptape Nodes Library", "ToText"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    ...
    gen_node = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            specific_library_name="Griptape Nodes Library",
            node_name="LTXAudioToVideoGeneration",
            metadata={},
            initial_setup=True,
        )
    ).node_name
