...
# dependencies = []
# [tool.griptape-nodes]
# name = "test_wan_animate_generation"
...
# node_types_used = [["Griptape Nodes Testing Library", "AssertFileExists"], ["Griptape Nodes Library", "EndFlow"], ["Griptape Nodes Library", "GenerateImage"], ["Griptape Nodes Library", "LTXTextToVideoGeneration"], ["Griptape Nodes Library", "ToText"], ["Griptape Nodes Library", "WanAnimateGeneration"]]
...
with GriptapeNodes.ContextManager().flow(flow_name):
    ...
    gen_node = GriptapeNodes.handle_request(
        CreateNodeRequest(
            ...
            specific_library_name="Griptape Nodes Library",
            node_name="WanAnimateGeneration",
            metadata={},
            initial_setup=True,
        )
    ).node_name
